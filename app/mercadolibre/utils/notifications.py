from app.shared.core.settings import SENDER_EMAIL,SENDER_PASSWORD,WPP_TOKEN,WPP_ID,PHONE_LIST
...
def notify_errors_intern(subject, message):
    """
        Send critical/unexpected errors directly to Guias Locales Email Inboox
    """
    ...
    try:
        with smtplib.SMTP(smtp_server, smtp_port) as server:
            ...
            logger.info("Intern email sended to Guias.")
